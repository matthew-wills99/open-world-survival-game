...
public class MapGen : MonoBehaviour
{
    ...
    public CAWaterController waterController;
    ...
    IEnumerator PopulateEnvironment()
    {
    ...
    IEnumerator GenerateMap()
    {
        ...
        CellularAutomata();
        yield return StartCoroutine(SmoothMap(-mapSizeInChunks / 2, -mapSizeInChunks / 2, mapSizeInChunks / 2, mapSizeInChunks / 2));
        ...
        PlaceBiomes();
        yield return StartCoroutine(SpreadBiomes()); // KEEP TRACK OF HIGHEST AND LOWEST WORLD COORDINATE THEN CONVERT IT BACK TO CHUNK COORDS
        ...
        yield return StartCoroutine(SmoothBiomes());

        TileVariation();
        //TileSplatting();

        yield return StartCoroutine(PopulateEnvironment());
